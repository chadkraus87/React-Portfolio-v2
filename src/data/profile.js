...
export const profile = {
  ...
  about: [
    'The ten projects on this site are the current answer to that. A permission-gated AI assistant running entirely on my own hardware. A pet health record whose sharing rules are enforced in Postgres rather than in the interface. A budgeting app that projects a daily cash runway from scheduled bills. An operations console for a homelab. Two games that teach networking and systems architecture by making you actually operate them.',
